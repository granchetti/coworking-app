...
import { Timestamp } from 'src/core/domain/value_objects/shared/timestamp.value-object';
import {
  Status,
  StatusType,
} from 'src/core/domain/value_objects/shared/status.value-object';
import { OfficeNumber } from 'src/core/domain/value_objects/office/office-number.value-object';
import { OfficeLeasePeriod } from 'src/core/domain/value_objects/office/office-lease-period.value-object';
